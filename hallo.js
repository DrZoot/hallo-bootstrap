  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloblock', {
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonset = jQuery("<div>").addClass(this.widgetName);
  ...
  (function(jQuery) {
    return jQuery.widget("IKS.halloformat", {
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonset = jQuery("<div>").addClass(widget.widgetName);
        buttonize = function(format) {
          ...
          return buttonset.append(jQuery(buttonHolder).find('button'));
        };
    ...
    return jQuery.widget("IKS.hallojustify", {
      ...
      populateToolbar: function(toolbar) {
        ...
        buttonize = function(alignment) {
          ...
          return buttonset.append(jQuery(buttonElement).find('button'));
